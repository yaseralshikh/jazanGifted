...
class ProvincesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('provinces')->insert([
            ...
            ['name' => 'شرق جازان', 'education_region_id' => 1, 'status' => 1],
            ['name' => 'غرب جازان', 'education_region_id' => 1, 'status' => 1],
            ['name' => 'شمال جازان', 'education_region_id' => 1, 'status' => 1],
            ['name' => 'جنوب جازان', 'education_region_id' => 1, 'status' => 1],
